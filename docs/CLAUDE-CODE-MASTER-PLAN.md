...
- [ ] **TASK 3.2 — content auto-detection (rule-based).** Depends: 3.1.
...
- [ ] **TASK M-CAM.1 — ONVIF discovery + RTSP auto-config.** Depends: 1.3.
...
- [ ] **TASK M-CAM.2 — export-folder watch presets for camera clips.** Depends: 4.1, 3.2.
...
- [ ] **TASK M-CAM.3 — bridge-ingestion guide (cloud-locked cams).** Depends: M-CAM.1.
...
- [ ] **TASK M-CAM.4 — consumer-camera preset family.** Depends: 3.1, M-CAM.2.
...
- [ ] **TASK 4.4 — dashboard auth for non-localhost binds.** Depends: 1.3. **Do this before 4.2.**
...
- [ ] **TASK 4.2 — Docker image (server scenario).** Depends: 2.3, 4.4.
...
- [ ] **TASK 5.2 — opt-in anonymous usage-stats channel.** Depends: none (can parallel).
