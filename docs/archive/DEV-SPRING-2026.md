> Archived 2026-09-24. This is the developer guide as it stood before the
> September 2026 cleanup (Spring 2026 content, pip-based setup, the old
> `capstone-compression` repo name, no Android app). It is kept for its
> history and module walkthroughs; the current guide is `DEV.md` at the repo
> root. Commands here may no longer work as written.
