# SVCS Roadmap: Spring 2026 (Archived)

This is the Spring 2026 capstone roadmap, kept as a historical record of what the
team planned and completed that semester (Phase 0 through Milestone 6, ending at the
May 6, 2026 course deadline). It is preserved here exactly as it stood at the end of
that semester and is NOT updated going forward.

For what the team is working on now, see the root `ROADMAP.md` (Fall 2026 semester).
For the fuller historical narrative across both semesters, see
